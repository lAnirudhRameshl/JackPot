...
public class JwtConfiguration {
    ...
    public KeyStore keyStore() {
        try {
            ...
            System.out.println("Unable to load keystore: " + e);
        }
    ...
    public RSAPrivateKey jwtSigningKey(KeyStore keyStore) {
        try {
            ...
            System.out.println("Unable to retrieve private key from Keystore: " + e);
        }
    ...
    public RSAPublicKey jwtValidationKey(KeyStore keyStore) {
        try {
            ...
            System.out.println("Unable to load private key from Keystore: " + e);
        }
